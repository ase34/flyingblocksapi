package de.ase34.flyingblocksapi.natives.v1_7_R1;
...
import de.ase34.flyingblocksapi.natives.v1_7_R1.util.EntityRegistrator;
...
public class NativesAPI extends de.ase34.flyingblocksapi.natives.api.NativesAPI {
    ...
    public List<Entity> removeFlyingBlocks(World world) {
        ...
        for (Object entityObject : nmsworld.entityList) {
            net.minecraft.server.v1_7_R1.Entity entity = (net.minecraft.server.v1_7_R1.Entity) entityObject;
