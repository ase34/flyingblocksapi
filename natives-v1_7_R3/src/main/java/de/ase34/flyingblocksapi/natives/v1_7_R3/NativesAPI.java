package de.ase34.flyingblocksapi.natives.v1_7_R3;
...
import de.ase34.flyingblocksapi.natives.v1_7_R3.entities.CustomFallingBlock;
import de.ase34.flyingblocksapi.natives.v1_7_R3.entities.CustomHorse;
import de.ase34.flyingblocksapi.natives.v1_7_R3.entities.CustomWitherSkull;
import de.ase34.flyingblocksapi.natives.v1_7_R3.util.EntityRegistrator;
...
public class NativesAPI extends de.ase34.flyingblocksapi.natives.api.NativesAPI {
    ...
    public List<Entity> removeFlyingBlocks(World world) {
        ...
        for (Object entityObject : nmsworld.entityList) {
            net.minecraft.server.v1_7_R3.Entity entity = (net.minecraft.server.v1_7_R3.Entity) entityObject;
