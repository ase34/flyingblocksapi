package de.ase34.flyingblocksapi.natives.v1_7_R2;
...
import de.ase34.flyingblocksapi.natives.v1_7_R2.entities.CustomFallingBlock;
import de.ase34.flyingblocksapi.natives.v1_7_R2.entities.CustomHorse;
import de.ase34.flyingblocksapi.natives.v1_7_R2.entities.CustomWitherSkull;
import de.ase34.flyingblocksapi.natives.v1_7_R2.util.EntityRegistrator;
...
public class NativesAPI extends de.ase34.flyingblocksapi.natives.api.NativesAPI {
    ...
    public List<Entity> removeFlyingBlocks(World world) {
        ...
        net.minecraft.server.v1_7_R2.World nmsworld = ((CraftWorld) world).getHandle();

        for (Object entityObject : nmsworld.entityList) {
            net.minecraft.server.v1_7_R2.Entity entity = (net.minecraft.server.v1_7_R2.Entity) entityObject;
