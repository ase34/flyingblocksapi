 ...
 */
package de.ase34.flyingblocksapi.natives.v1_7_R2.util;
...
public class EntityRegistrator {
    ...
    static {
        try {
            mapStringToClassField = net.minecraft.server.v1_7_R2.EntityTypes.class
                    .getDeclaredField("c");
            mapClassToStringField = net.minecraft.server.v1_7_R2.EntityTypes.class
                    .getDeclaredField("d");
            // mapIdtoClassField = net.minecraft.server.v1_7_R2.EntityTypes.class.getDeclaredField("e");
            mapClassToIdField = net.minecraft.server.v1_7_R2.EntityTypes.class
                    .getDeclaredField("f");
            mapStringToIdField = net.minecraft.server.v1_7_R2.EntityTypes.class
                    .getDeclaredField("g");
